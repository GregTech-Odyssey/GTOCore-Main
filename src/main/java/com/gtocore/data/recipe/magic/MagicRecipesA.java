...
public final class MagicRecipesA {
    ...
    public static void init() {
        ...
        // 炼金锅1
        {
            ...
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("phantomic_electrolyte_buffer1")
                    .inputItems(dust, EDTA, 16)
                    .inputItems(Items.PHANTOM_MEMBRANE, 64)
                    .chancedInput(Animium.getFluid(40000), 1, 0)
                    .inputFluids(GaiaSolvent, 500)
                    .chancedOutput(PhantomicElectrolyteBuffer.getFluid(4500), 1, 0)
                    .chancedOutput(Ethylenediamine.getFluid(50), 5, 0)
                    .circuitMeta(1)
                    .duration(600)
                    .temperature(1200)
                    .MANAt(32)
                    .addData(GTORecipeDataKeys.PARAM1, 325)
                    .addData(GTORecipeDataKeys.PARAM2, 476)
                    .addData(GTORecipeDataKeys.PARAM3, 947)
                    .save();
        ...
        // 炼金锅2
        {
            ...
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy1")
                    .inputItems(dust, GnomeCrystal)
                    .inputItems(dust, UndineCrystal)
                    .inputItems(dust, SylphCrystal)
                    .inputItems(dust, SalamanderCrystal)
                    .outputItems(dust, PerditioCrystal)
                    .addData(GTORecipeDataKeys.PARAM1, 0)
                    .addData(GTORecipeDataKeys.PARAM2, 0)
                    .addData(GTORecipeDataKeys.PARAM3, 0)
                    .duration(200)
                    .MANAt(8)
                    .circuitMeta(21)
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy2")
                    .inputItems(dust, GnomeCrystal)
                    .inputItems(dust, UndineCrystal)
                    .inputItems(dust, SylphCrystal)
                    .inputItems(dust, PerditioCrystal)
                    .outputItems(dust, SalamanderCrystal)
                    .addData(GTORecipeDataKeys.PARAM1, 0)
                    .addData(GTORecipeDataKeys.PARAM2, 0)
                    .addData(GTORecipeDataKeys.PARAM3, 20000)
                    .duration(200)
                    .MANAt(8)
                    .circuitMeta(22)
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy3")
                    .inputItems(dust, GnomeCrystal)
                    .inputItems(dust, UndineCrystal)
                    .inputItems(dust, SalamanderCrystal)
                    .inputItems(dust, PerditioCrystal)
                    .outputItems(dust, SylphCrystal)
                    .addData(GTORecipeDataKeys.PARAM1, 0)
                    .addData(GTORecipeDataKeys.PARAM2, 20000)
                    .addData(GTORecipeDataKeys.PARAM3, 0)
                    .duration(200)
                    .MANAt(8)
                    .circuitMeta(23)
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy4")
                    .inputItems(dust, GnomeCrystal)
                    .inputItems(dust, SalamanderCrystal)
                    .inputItems(dust, SylphCrystal)
                    .inputItems(dust, PerditioCrystal)
                    .outputItems(dust, UndineCrystal)
                    .addData(GTORecipeDataKeys.PARAM1, 20000)
                    .addData(GTORecipeDataKeys.PARAM2, 0)
                    .addData(GTORecipeDataKeys.PARAM3, 0)
                    .duration(200)
                    .MANAt(8)
                    ...
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy5")
                    .inputItems(dust, UndineCrystal)
                    .inputItems(dust, SylphCrystal)
                    .inputItems(dust, SalamanderCrystal)
                    .inputItems(dust, PerditioCrystal)
                    .outputItems(dust, GnomeCrystal)
                    .addData(GTORecipeDataKeys.PARAM1, 20000)
                    .addData(GTORecipeDataKeys.PARAM2, 20000)
                    .addData(GTORecipeDataKeys.PARAM3, 20000)
                    .duration(200)
                    ...
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy6")
                    .inputItems(dust, UndineCrystal, 3)
                    .inputItems(dust, SylphCrystal, 3)
                    .inputItems(dust, PerditioCrystal, 3)
                    .inputFluids(TheWaterFromTheWellOfWisdom, 1000)
                    .outputItems(dust, SalamanderCrystal)
                    .outputItems(dust, GnomeCrystal)
                    .addData(GTORecipeDataKeys.PARAM1, 20000)
                    ...
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy7")
                    .inputItems(dust, GnomeCrystal, 3)
                    .inputItems(dust, SylphCrystal, 3)
                    .inputItems(dust, PerditioCrystal, 3)
                    .inputFluids(TheWaterFromTheWellOfWisdom, 1000)
                    .outputItems(dust, SalamanderCrystal)
                    ...
                    .temperature(400)
                    .save();
            ALCHEMY_CAULDRON_RECIPES.recipeBuilder("alchemy8")
                    .inputItems(dust, GnomeCrystal, 3)
                    .inputItems(dust, UndineCrystal, 3)
                    .inputItems(dust, PerditioCrystal, 3)
                    .inputFluids(TheWaterFromTheWellOfWisdom, 1000)

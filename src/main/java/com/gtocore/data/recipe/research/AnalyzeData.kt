...
object AnalyzeData : AutoInitialize<AnalyzeData>() {
    ...
    val techTree: TechTreeManager<Map<ResearchTag, Long>> = TechTreeManager("main_tree", "研究树", "Research Tree", ItemStackTexture(GTOItems.BLUE_HALIDE_LAMP.asStack()))
    ...
    private fun tier1(): (Map<ResearchTag, Long>?, UUID) -> ActionResult = { uu, id -> ActionResult.SUCCESS } // TODO: Implement tier restrictions
    private fun tier2(): (Map<ResearchTag, Long>?, UUID) -> ActionResult = { uu, id -> ActionResult.SUCCESS } // TODO: Implement tier restrictions
    private fun tier3(): (Map<ResearchTag, Long>?, UUID) -> ActionResult = { uu, id -> ActionResult.SUCCESS } // TODO: Implement tier restrictions
    private fun tier4(): (Map<ResearchTag, Long>?, UUID) -> ActionResult = { uu, id -> ActionResult.SUCCESS } // TODO: Implement tier restrictions
    private fun tier5(): (Map<ResearchTag, Long>?, UUID) -> ActionResult = { uu, id -> ActionResult.SUCCESS } // TODO: Implement tier restrictions
}

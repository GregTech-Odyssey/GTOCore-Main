...
final class Centrifuge {
    ...
    public static void init() {
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_thorium_simple")
                ...
                .chancedOutput(dust, GTMaterials.Uranium238, 4, 4000, 500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_uranium_dual")
                ...
                .chancedOutput(dust, GTMaterials.Plutonium239, 12, 2500, 100)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("fissioned_uranium_235_dust")
                .inputItems(dust, GTOMaterials.FissionedUranium235)
                .outputItems(dust, GTMaterials.Tin)
                .outputItems(dust, GTMaterials.Technetium)
                .EUt(1920)
                .duration(400)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_naquadah_quad")
                ...
                .chancedOutput(dust, GTMaterials.Plutonium239, 8, 8000, 200)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dragon_element")
                ...
                .outputItems(dust, GTMaterials.Collagen)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_uranium_quad")
                ...
                .chancedOutput(dust, GTMaterials.Plutonium239, 24, 2500, 100)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 8, 8000, 500)
                .EUt(480)
                .duration(160)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_naquadah_dual")
                ...
                .chancedOutput(dust, GTMaterials.Plutonium239, 4, 8000, 200)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 4, 3600, 500)
                .EUt(480)
                .duration(80)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_uranium_simple")
                ...
                .outputItems(GTOItems.REACTOR_FUEL_ROD)
                .chancedOutput(dust, GTMaterials.Plutonium239, 6, 2500, 100)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 2, 1600, 500)
                .EUt(480)
                .duration(40)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("iodine_dust")
                ...
                .outputItems(dust, GTMaterials.RockSalt, 2)
                .EUt(120)
                .duration(200)
                .save();

        CENTRIFUGE_RECIPES.recipeBuilder("actinium_radium_nitrate_solution")
                .notConsumable(dust, GTOMaterials.TrifluoroaceticPhosphateEster)
                .inputFluids(GTOMaterials.ActiniumRadiumNitrateSolution, 13000)
                .outputItems(dust, GTOMaterials.ActiniumNitrate, 26)
                .outputItems(dust, GTOMaterials.RadiumNitrate, 27)
                .chancedOutput(dust, GTMaterials.Francium, 4, 2500, 0)
                .chancedOutput(dust, GTMaterials.Thorium, 2500, 0)
                .chancedOutput(dust, GTMaterials.Protactinium, 2, 2500, 0)
                .chancedOutput(dust, GTMaterials.Radium, 2500, 0)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("inert_residues_dust")
                .notConsumable(GTOItems.SEPARATION_ELECTROMAGNET.asItem())
                .inputItems(dust, GTOMaterials.MetalResidue, 10)
                .inputFluids(GTMaterials.DistilledWater, 10000)
                .outputItems(dust, GTOMaterials.InertResidues)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_thorium_quad")
                ...
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 4)
                .outputItems(TagPrefix.rod, GTMaterials.Steel, 12)
                .chancedOutput(dust, GTMaterials.Uranium238, 16, 4000, 500)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 8, 8000, 500)
                .EUt(480)
                .duration(160)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_naquadah_simple")
                ...
                .chancedOutput(dust, GTMaterials.Plutonium239, 2, 8000, 200)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 2, 1600, 500)
                .EUt(480)
                .duration(40)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("depleted_reactor_thorium_dual")
                ...
                .outputItems(GTOItems.REACTOR_FUEL_ROD, 2)
                .outputItems(TagPrefix.rod, GTMaterials.Steel, 4)
                .chancedOutput(dust, GTMaterials.Uranium238, 8, 4000, 500)
                .chancedOutput(GTOItems.NUCLEAR_WASTE.asItem(), 4, 3600, 500)
                .EUt(480)
                .duration(80)
                .save();
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("heavily_fluorinated_trinium_solution")
                ...
                .outputItems(dust, GTOMaterials.TriniumTetrafluoride, 60)
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_1")
                ...
                .outputItems(dust, GTMaterials.Protactinium, 6)
                .outputItems(dust, GTMaterials.Uranium238, 3)
                .outputItems(dust, GTMaterials.Uranium235, 3)
                .outputItems(dust, GTMaterials.Thallium)
                .EUt(30720)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_2")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Protactinium, 3)
                .outputItems(dust, GTMaterials.Uranium238, 6)
                .outputItems(dust, GTMaterials.Uranium235, 6)
                .outputItems(dust, GTMaterials.Thallium)
                .EUt(30720)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_3")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Uranium235, 4)
                .outputItems(dust, GTMaterials.Uranium238, 2)
                .outputItems(dust, GTMaterials.Neptunium, 9)
                .outputItems(dust, GTMaterials.Astatine)
                .EUt(30720)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_4")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Uranium238, 4)
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_5")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Neptunium, 3)
                .outputItems(dust, GTMaterials.Plutonium239, 6)
                .outputItems(dust, GTMaterials.Plutonium241, 6)
                .outputItems(dust, GTMaterials.Astatine)
                .EUt(30720)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_6")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Plutonium239, 4)
                .outputItems(dust, GTMaterials.Plutonium241, 2)
                .outputItems(dust, GTMaterials.Americium, 9)
                .outputItems(dust, GTMaterials.Radium)
                .EUt(122880)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_7")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Plutonium241, 4)
                .outputItems(dust, GTMaterials.Plutonium239, 2)
                .outputItems(dust, GTMaterials.Americium, 9)
                .outputItems(dust, GTMaterials.Radium)
                .chancedOutput(dust, GTOMaterials.LightEmittingChargedSuspiciousWaste, 4, 2000, 0)
                .EUt(122880)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_8")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Americium, 3)
                .outputItems(dust, GTMaterials.Plutonium239, 3)
                .outputItems(dust, GTMaterials.Plutonium241, 3)
                .outputItems(dust, GTMaterials.Curium, 6)
                .outputItems(dust, GTMaterials.Radium)
                .chancedOutput(dust, GTOMaterials.LightEmittingChargedSuspiciousWaste, 4, 4000, 0)
                .EUt(122880)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_9")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Curium, 3)
                .outputItems(dust, GTMaterials.Berkelium, 9)
                .outputItems(dust, GTMaterials.Astatine, 2)
                .outputItems(dust, GTMaterials.Radium)
                .outputItems(dust, GTMaterials.Actinium)
                .chancedOutput(dust, GTOMaterials.LightEmittingChargedSuspiciousWaste, 4, 6000, 0)
                .EUt(122880)
                .duration(320)
                .save();
        ...
        CENTRIFUGE_RECIPES.builder("tungsten_carbide_reactor_fuel_rod_10")
                ...
                .outputItems(GTOItems.TUNGSTEN_CARBIDE_REACTOR_FUEL_ROD)
                .outputItems(dust, GTMaterials.Berkelium, 3)
                .outputItems(dust, GTMaterials.Californium, 9)
                .outputItems(dust, GTOMaterials.Californium252Source, 3)
                .outputItems(dust, GTMaterials.Actinium)
                .chancedOutput(dust, GTOMaterials.LightEmittingChargedSuspiciousWaste, 4, 8000, 0)
                .EUt(491520)
                .duration(320)
                .save();

        CENTRIFUGE_RECIPES.builder("recycle_basic_mfpc_dust")
                .inputItems(dust, GTOMaterials.InvalidationCascadeMFPC)
                .outputItems(dust, GTOMaterials.RecycleBasicMFPC)
                .EUt(1200)
                .duration(1200)
                .save();
        CENTRIFUGE_RECIPES.builder("small_apatite_dust")
                .inputItems(dust, GTOMaterials.AerogelPorousParticles, 16)
                .outputItems(GTOTagPrefix.dustSmall, GTMaterials.Apatite, 4)
                .outputItems(dust, GTOMaterials.SilicaAluminaGel)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("jupiter_air")
                .inputFluids(GTOMaterials.JupiterAir, FluidStorageKeys.GAS, 10000)
                .outputFluids(GTMaterials.CarbonDioxide, 100)
                .outputFluids(GTMaterials.Water, 100)
                .outputFluids(GTMaterials.Methane, 3400)
                .outputFluids(GTMaterials.Ammonia, 16000)
                .outputFluids(GTMaterials.Hydrogen, 5000)
                .outputFluids(GTMaterials.Helium, 100)
                .EUt(1920)
                .duration(100)
                .save();
        CENTRIFUGE_RECIPES.recipeBuilder("glacial_air")
                .inputFluids(GTOMaterials.GlacioAir, FluidStorageKeys.GAS, 10000)
                .outputFluids(GTMaterials.CarbonDioxide, 500)
                .outputItems(dust, GTMaterials.Ice, 1)
                .outputFluids(GTMaterials.Argon, 400)
                .outputFluids(GTMaterials.Oxygen, 2000)
                .outputFluids(GTMaterials.Nitrogen, 7000)
                .EUt(1920)
                .duration(100)
                .save();
    }

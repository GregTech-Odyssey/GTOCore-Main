...
final class NanitesIntegratedProcessingCenter {
    ...
    public static void init() {
        ...
        NANITES_INTEGRATED_PROCESSING_CENTER_RECIPES.builder("rare_earth3")  // 铜纳米蜂群
                ...
                .addData(GTORecipeDataKeys.MODULE, 1)
                .save();
        NANITES_INTEGRATED_PROCESSING_CENTER_RECIPES.builder("contaminable_runerock_nanites")
                .inputItems(GTOTagPrefix.NANITES, GTOMaterials.Runerock)
                .inputItems("ars_nouveau:manipulation_essence", 16)
                .inputItems("botania:pixie_dust", 64)
                .inputItems("botania:forest_eye", 3)
                .inputItems(TagPrefix.block, GTOMaterials.Shimmerrock, 6)
                .inputItems("botania:glimmering_dreamwood", 6)
                .inputItems(TagPrefix.gem, GTOMaterials.Dragonstone, 4)
                .inputItems("ars_nouveau:mirrorweave", 32)
                .inputItems("botania:light_relay", 6)
                .outputItems(GTOTagPrefix.CONTAMINABLE_NANITES, GTOMaterials.Runerock)
                .outputItems(GTOItems.UNSTABLE_GAIA_SOUL, 4)
                .inputFluids(GTOMaterials.FractalPetalSolvent, 232000)
                .inputFluids(GTMaterials.Gold, 864)
                .inputFluids(GTOMaterials.Gaiasteel, 864)
                .inputFluids(GTOMaterials.Terrasteel, 1296)
                .inputFluids(GTOMaterials.Mana, 16704)
                .inputFluids(GTOMaterials.Alfsteel, 864)
                .inputFluids(GTOMaterials.Laureril, 864)
                .inputFluids(GTOMaterials.Herbs, 864)
                .EUt(1048000)
                .addData(GTORecipeDataKeys.MODULE, 4)

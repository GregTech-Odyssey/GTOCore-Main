...
final class MachineLang {
    ...
    static void init() {
        ...
        addCNEN("gtocore.machine.spacestation.module_count", "连接的模块舱数量： %s", "Amount of Connected Module Hatches: %s");
        addCNEN("gtocore.machine.spacestation.energy_consumption.total", "所有空间站舱段总能量消耗： %s EU/t", "Total Energy Consumption of All Space Station Modules: %s EU/t");

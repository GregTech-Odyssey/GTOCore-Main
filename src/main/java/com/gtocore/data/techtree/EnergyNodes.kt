...
object EnergyNodes : AutoInitialize<EnergyNodes>() {
    @JvmField
    val LapotronEnergeStorge = TechTree.builder("high_density_energy_storage", "兰博顿水晶能量存储", "Lapotron Crystal Energy Storage")
    ...
    @JvmField
    val HyperReactor = TechTree.builder("hyper_reactor", "超能反应堆", "Hyper Reactor")

...
object AENodes : AutoInitialize<AENodes>() {
    @JvmField
    val BaseMEMachines = AETree.builder("base_me_machines", "基础ME机器", "Basic ME Machines")
    ...
    @JvmField
    val MECapacityExpansion = AETree.builder("me_capacity_expansion", "ME设备扩容", "ME Capacity Expansion")
    ...
    @JvmField
    val MECatalystSupplying = AETree.builder("me_catalyst_supplying", "ME催化剂供应", "ME Catalyst Supplying")
    ...
    @JvmField
    val MESmartGatingClustering = AETree.builder("me_smart_gating_clustering", "ME智能分流集群", "ME Smart Gating Clustering")
    ...
    @JvmField
    val MEWasteRecycling = AETree.builder("me_waste_recycling", "ME废料回收", "ME Waste Recycling")

...
public class OverlayActiveMachineRenderer extends MachineRenderer {

    protected IModelRenderer activeOverlayModel;
    protected IModelRenderer overlayModel;

    public OverlayActiveMachineRenderer(ResourceLocation baseModel, ResourceLocation overlayModel,

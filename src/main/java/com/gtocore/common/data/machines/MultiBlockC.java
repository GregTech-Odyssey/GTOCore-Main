...
public final class MultiBlockC {
    ...
    public static final MultiblockMachineDefinition ORE_EXTRACTION_MODULE = multiblock("ore_extraction_module", "矿石萃取模块", h -> new NanitesModuleMachine(h, 1))
            ...
            .pattern(definition -> MultiBlockFileReader.start(definition)
                    ...
                    .wherePart('a', blocks(GTBlocks.CASING_HSSE_STURDY.get()).or(abilities(PARALLEL_HATCH).setMaxGlobalLimited(1)).or(GTOPredicates.autoLaserAbilities(definition.getRecipeTypes())))
                    .where(' ', any())
                    .build())
